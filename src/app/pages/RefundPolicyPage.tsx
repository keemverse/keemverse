...
export default function RefundPolicyPage() {
  return (
    <InfoPage eyebrow="Policy" title="Refund & Delivery Policy">
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Digital products</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Delivery</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Purchases via third-party platforms</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Services</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">How to request a refund</h2>
      <p>
        Email us at{' '}
        <a href="mailto:akeemtajudeen322@gmail.com" className="text-foreground underline underline-offset-4">
          akeemtajudeen322@gmail.com
