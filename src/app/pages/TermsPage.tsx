...
export default function TermsPage() {
  return (
    <InfoPage eyebrow="Policy" title="Terms and Conditions">
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">About Keemverse</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Products and services</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Licensing</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Payment</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Liability</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Governing law</h2>
      <p>These terms are governed by the laws of the Federal Republic of Nigeria.</p>

      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Contact</h2>
      <p>
        Questions about these terms? Email{' '}
        <a href="mailto:akeemtajudeen322@gmail.com" className="text-foreground underline underline-offset-4">
