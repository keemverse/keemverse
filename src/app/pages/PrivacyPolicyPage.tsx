...
export default function PrivacyPolicyPage() {
  return (
    <InfoPage eyebrow="Policy" title="Privacy Policy">
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">What we collect</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">How we use it</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Third-party services</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Your rights</h2>
      <p>
      ...
      <h2 className="font-serif text-xl text-foreground mt-8 mb-2">Changes to this policy</h2>
      <p>
