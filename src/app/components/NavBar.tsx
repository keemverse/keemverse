...
>
        <ImageWithFallback
          ...
          alt={isFashion ? 'Keem' : 'KEEMVERSE'}
          className={
            isFashion
              ? 'h-13 w-13 rounded-full object-cover border border-white shadow-lg'
              : 'h-13 w-auto object-contain opacity-90'
          }
        />
      </div>

      <div className="bg-white/90 backdrop-blur-md p-1.5 rounded-full flex w-[300px] sm:w-auto shadow-lg border border-stone-200 relative">
        <div
